...
@interface OQJExploreViewConlvyouinternational6 ()
...
@implementation OQJExploreViewConlvyouinternational6
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return cell;
    NSLog(@"66xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx%f",_collectionView.contentSize.height);
