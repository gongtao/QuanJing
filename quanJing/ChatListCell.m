    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _detailLabel = [[UILabel alloc] initWithFrame:CGRectMake(65+3, 30, 175, 20)];
        ...
        _roundProfile = [[OWTRoundImageView alloc]initWithFrame:CGRectMake(10, 7, 45+3, 45+3)];
        [self.contentView addSubview:_roundProfile];
...
-(void)layoutSubviews{
    ...
    [self.roundProfile sd_setImageWithURL:_imageURL placeholderImage:_placeholderImage];
    self.roundProfile.frame = CGRectMake(10, 7, 45+3, 45+3);
    
    self.textLabel.text = _name;
    self.textLabel.frame = CGRectMake(65+3, 7, 175, 20);
