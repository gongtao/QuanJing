...
@interface OQJExploreViewConlvyouinternational1 ()
...
@implementation OQJExploreViewConlvyouinternational1
{
...
- (void)reloadData
{
 ...
 //   _categories = GetCategoryManagerlvyouinternational().categories;
    ...
    for (OWTCategory*oc in arr) {
        NSLog(@"categoryName: %@   %@",oc,oc.GroupName);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"11xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx%f",_collectionView.contentSize.height);
