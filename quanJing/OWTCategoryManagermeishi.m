...
@interface OWTCategoryManagermeishi()

@property (nonatomic, strong) NSDate* lastRefreshTime;

@end

@implementation OWTCategoryManagermeishi
...
- (void)setup
{
    ...
    NSString *homePath  = [homeDictionary stringByAppendingString:@"/Documents/cachemeishi.archiver"];
                             ...
                             failure:(void(^)(NSError* error))failure
{
    ...
    if (_keyPath ==0) {
        ...
        [om getObject:nil
                 path:@"cdn2/feeds/multilevel13_new"
           parameters:nil
