...
-(void)layoutSubviews
{
    ...
    if (self.model.isSender) {
        frame.origin.x = BUBBLE_VIEW_PADDING-2;
    }else{
        frame.origin.x = BUBBLE_VIEW_PADDING + BUBBLE_ARROW_WIDTH+2.5;
    }
    
    frame.origin.y = BUBBLE_VIEW_PADDING-2.5;
    [self.imageView setFrame:frame];
    self.imageView.backgroundColor = HWColor(232, 232, 232);
}
