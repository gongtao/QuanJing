...
//        _doneButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"完成", nil) style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonPressed:)];
        //ic_back_white
        CGSize imgesze = CGSizeMake(27,27);
        UIImage *iamge = [UIImage imageNamed:@"ic_back_white"];
        UIImage *imge = [iamge imageByScalingToSize:imgesze];
        _doneButton = [[UIBarButtonItem alloc] initWithImage:imge style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonPressed:)];
        // Set appearance
