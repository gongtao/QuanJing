    ...
    @synchronized (self)
    {
        if (_selected != selected)
        {
            ...
            if (self.selected) {
                ...
                [self.checkmarkImageView setImageWithAnimation:[UIImage imageNamed:@"照片管理2_05(1).png"] forState:UIControlStateNormal];
            } else {
                [self.checkmarkImageView setImage:[UIImage imageNamed:@"照片管理2_05(2).png"] forState:UIControlStateNormal];
            }
...
- (void)layoutSubviews
{
    ...
    if (self.selected) {
        [self.checkmarkImageView setImage:[UIImage imageNamed:@"照片管理2_05(1).png"] forState:UIControlStateNormal];
    } else {
        [self.checkmarkImageView setImage:[UIImage imageNamed:@"照片管理2_05(2).png"] forState:UIControlStateNormal];
    }
}
