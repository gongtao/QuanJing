...
//static NSString * const kQJServerURL = @"http://mapp_beta.tiankong.com:8084";
...
// 环信注册
static NSString * const kQJHuanXinRegistPath = @"/user/easemob.regist";
...
// 图片修改
static NSString * const kQJImageModifyPath = @"/imageUser/update.user";

// 图片删除
static NSString * const kQJImageDeletePath = @"/imageUser/delete.user";
