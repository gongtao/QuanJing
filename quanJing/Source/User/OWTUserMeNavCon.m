...
- (void)getCaptionData
{
	...
	[[QJDatabaseManager sharedManager] performDatabaseUpdateBlock:^(NSManagedObjectContext * _Nonnull concurrencyContext) {
		NSArray * words = [wmanager getAllSearchWords:concurrencyContext];
