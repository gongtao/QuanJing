...
#import "ChatViewController_renameA.h"
...
@interface ChatViewController_renameA ()<UITableViewDataSource, UITableViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, IChatManagerDelegate, DXMessageToolBarDelegate, IDeviceManagerDelegate>
{
...
@property(nonatomic,strong)UIImage *mFirmImage;
@end

@implementation ChatViewController_renameA

- (instancetype)initWithChatter:(NSString *)chatter isGroup:(BOOL)isGroup firmImageMsg:(UIImage*) firmImage
{
    ...
    if (self) {
        ...
        _conversation = [[EaseMob sharedInstance].chatManager conversationForChatter:@"18612110008" isGroup:NO];
        [_conversation markAllMessagesAsRead:YES];
        _mFirmImage = firmImage;
...
- (DXMessageToolBar *)chatToolBar
{
    ...
    if (_chatToolBar == nil) {
        _chatToolBar = [[DXMessageToolBar alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - [DXMessageToolBar defaultHeight], self.view.frame.size.width+50, [DXMessageToolBar defaultHeight])];
...
-(void)chatAudioCellBubblePressed:(MessageModel *)model
{
    ...
    if (model.type == eMessageBodyType_Voice) {
        __weak ChatViewController_renameA *weakSelf = self;
