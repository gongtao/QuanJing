...
@property (assign, nonatomic) BOOL ifEnableColor;
...
- (UIImageView *)toolbarBackgroundImageView
{
    if (_toolbarBackgroundImageView == nil) {
        ...
        if (!_ifEnableColor) {
            _toolbarBackgroundImageView.backgroundColor = HWColor(244, 244, 244);
...
-(void)setToolbarBackground:(UIColor *)backgroudColor
{
    _ifEnableColor = YES;
    _toolbarBackgroundImageView.backgroundColor = backgroudColor;
}
...
- (void)setupConfigure
{
    ...
    self.backgroundImageView.image = [[UIImage imageNamed:@"messageToolbarBg"] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];//按住说话
...
- (void)setupSubviews
{
    ...
    //转变输入样式
    self.styleChangeButton = [[UIButton alloc] initWithFrame:CGRectMake(kHorizontalPadding-8, kVerticalPadding, kInputTextViewMinHeight, kInputTextViewMinHeight)];
    self.styleChangeButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    [self.styleChangeButton setImage:[UIImage imageNamed:@"wechatSound1"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"wechatKeybord1"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"wechatAdd1"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"wechatAdd1"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"wechatKeybord1"] forState:UIControlStateSelected];
    ...
    //表情
    self.faceButton = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight-35*SCREEN_WIDTH/320, kVerticalPadding, kInputTextViewMinHeight, kInputTextViewMinHeight)];
    
    self.faceButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleLeftMargin;//chatBar_more_face
    [self.faceButton setImage:[UIImage imageNamed:@"wechatSmile1"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"wechatSmile1"] forState:UIControlStateHighlighted];
    ...
    // 输入框的高度和宽度
    CGFloat width = CGRectGetWidth(self.bounds) - (allButtonWidth ? allButtonWidth : (textViewLeftMargin * 2))+15*SCREEN_WIDTH/320;
    // 初始化输入框
    self.inputTextView = [[XHMessageTextView  alloc] initWithFrame:CGRectMake(textViewLeftMargin+self.moreButton.frame.size.width/2-15*SCREEN_WIDTH/320-10, kVerticalPadding+2, width+10, kInputTextViewMinHeight-4)];
    ...
    _inputTextView.placeHolder = NSLocalizedString(@"", @"input a new message");
    ...
    //录制
    self.recordButton = [[UIButton alloc] initWithFrame:CGRectMake(textViewLeftMargin+self.moreButton.frame.size.width/2-15*SCREEN_WIDTH/320-10, kVerticalPadding+2, width, kInputTextViewMinHeight-4)];
...
- (void)buttonAction:(id)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(inputTextViewWillBeginEditing:)]) {
        [self.delegate inputTextViewWillBeginEditing:nil];
    }
