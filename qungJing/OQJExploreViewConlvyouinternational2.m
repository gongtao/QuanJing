...
@interface OQJExploreViewConlvyouinternational2 ()
...
@implementation OQJExploreViewConlvyouinternational2
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return cell;
    NSLog(@"22xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx%f",_collectionView.contentSize.height);
}
