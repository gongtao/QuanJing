...
#define kTouchToRecord NSLocalizedString(@"按住  说话", @"hold down to talk")
#define kTouchToFinish NSLocalizedString(@"松开  发送", @"loosen to send")
...
@property (nonatomic, strong) void(^getStatusBlock)();

@property (nonatomic, strong) BOOL (^getAuthStatusBlock)();
...
@property (nonatomic, assign)BOOL ifEnable;
