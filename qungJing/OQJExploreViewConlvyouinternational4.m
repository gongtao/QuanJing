...
@interface OQJExploreViewConlvyouinternational4 ()
...
@implementation OQJExploreViewConlvyouinternational4
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return cell;
     NSLog(@"44xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx%f",_collectionView.contentSize.height);
}
