...
@interface OQJExploreViewConlvyouinternational3 ()
...
@implementation OQJExploreViewConlvyouinternational3
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return cell;
    NSLog(@"33xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx%f",_collectionView.contentSize.height);
