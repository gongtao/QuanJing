...
@implementation OWTAssetInfoViewa
...
- (void)awakeFromNib
{
    ...
    __weak OWTAssetInfoViewa* wself = self;
    ...
    if (_asset != nil)
    {
        ...
        if (_assetOwnerUser != nil)
        {
            ...
            if (aa.location != NSNotFound) {
                ...
                _avatarImageView.hidden = YES;
                //
                _captionLabel.centerX=-32;
               
                _usernameButton.centerX=-32;
                _likesImageView.centerX=-32;
                _latestCommentsView.centerX=-32;
