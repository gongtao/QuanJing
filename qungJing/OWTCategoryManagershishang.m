...
@interface OWTCategoryManagershishang()

@property (nonatomic, strong) NSDate* lastRefreshTime;

@end

@implementation OWTCategoryManagershishang
...
- (void)setup
{
    ...
    NSString *homePath  = [homeDictionary stringByAppendingString:@"/Documents/cacheshishang.archiver"];
