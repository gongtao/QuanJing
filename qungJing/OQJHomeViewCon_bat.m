...
-(void)loadViewData
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://app.quanjing.com/qjapi/articleHome"];
    ...
    if (response!=nil) {
        dic0 =[NSJSONSerialization JSONObjectWithData:response options:NSJSONReadingMutableLeaves error:nil];
...
//              [scrollV addSubview:imageV1];
               ...
               // NSLog(@"hhhhhhhhhhhhhhhh%f",[UIScreen mainScreen].bounds.size.height);
                ...
                //    }
                //    imageV.frame = CGRectMake(0, 20, 320, 1197);
    ...
    [scrollV addHeaderWithTarget:self action:@selector(refresh) dateKey:@"table"];
    ...
    scrollV.footerPullToRefreshText = @" ";
    
    scrollV.footerReleaseToRefreshText = @" ";
    
    scrollV.footerRefreshingText = @" ";
...
- (void)refresh
{
    ...
    [self.view addSubview:view];
    scrollV = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 20, 320, self.view.bounds.size.height)];
    scrollV.contentSize =CGSizeMake(320, 1197+20+30+10+10+60-36+20-100);
    scrollV.delegate =self;
    [self.view addSubview:scrollV];
...
//                        NSLog(@"\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\");
                    ...
                    if (i==11) {
                        ...
                        NSURL *url1 = [NSURL URLWithString:@"http://app.quanjing.com/qjapi/daily"];
...
//    
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://app.quanjing.com/qjapi/hottag?count=8&page=%d",_pageCount]];
