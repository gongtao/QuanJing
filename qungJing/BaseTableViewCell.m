...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _roudContactProfile = [[OWTRoundImageView alloc]initWithFrame:CGRectMake(10, 8, 34, 34)];
        [self.contentView addSubview:_roudContactProfile];
...
-(void)layoutSubviews
{
    ...
    _roudContactProfile.frame = CGRectMake(10, 8, 34, 34);
    
    CGRect rect = self.textLabel.frame;
    rect.origin.x = CGRectGetMaxX(self.roudContactProfile.frame) + 10;
